...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback{
    ...
    JSONArray jsonArray;
    ImageButton lodge_complaint, see_dustbins, see_toilets;
    Button check_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lodge_complaint = (ImageButton) findViewById(R.id.imageButton2);
        see_dustbins = (ImageButton) findViewById(R.id.imageButton1);
        see_toilets = (ImageButton) findViewById(R.id.imageButton3);
       ...
       /* pref.setmobile("9479518452");*/
        ...
        lodge_complaint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialogManager alert = new AlertDialogManager();
                ConnectionDetector    cd = new ConnectionDetector(getApplicationContext());
        ...
        see_dustbins.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialogManager alert = new AlertDialogManager();
                ConnectionDetector    cd = new ConnectionDetector(getApplicationContext());
                ...
                if (!cd.isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        jsonArray = JO.optJSONArray("dustbins");
                        int count = 0;
                        String name, lat, lng;
            ...
            public void onClick(View v) {
                ...
                if (!cd.isConnectingToInternet()) {
                    ...
                    try {
                        ...
                        jsonArray = JO.optJSONArray("toilets");
                        int count = 0;
                        String name, lat, lng;
 ...
 /*       }
    ...
    class BackGroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            json_url[2] = Constants.DUSTBIN_URL;
